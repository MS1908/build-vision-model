...
parser.add_argument('--img-size', default=None, type=int, nargs='*',
...
def main():
    ...
    assert len(args.img_size) <= 2, "List/tuple of sizes must be of format (h, w) or (imgsz,)"
    if len(args.img_size) != 2:
        args.img_size = (args.img_size[0], args.img_size[0])
    else:
        args.img_size = (args.img_size[0], args.img_size[1])
